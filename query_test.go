...
import (
	...
	"github.com/bcext/neutrino/cache"
	"github.com/bcext/neutrino/cache/lru"
...
var (
	...
	// TODO use bitcoin core magic for block store testing
...
// a slice of them.
//
// NOTE: copied from bcext/gcash/database/ffldb/interface_test.go
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) (
	...
	blocks := make([]*cashutil.Block, 0, 256)
	genesis := cashutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
