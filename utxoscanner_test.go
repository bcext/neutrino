...
type MockChainClient struct {
	getBlockResponse     map[chainhash.Hash]*cashutil.Block
...
func NewMockChainClient() *MockChainClient {
	return &MockChainClient{
		getBlockResponse:     make(map[chainhash.Hash]*cashutil.Block),
		getBlockHashResponse: make(map[int64]*chainhash.Hash),
		getCFilterResponse:   make(map[chainhash.Hash]*gcs.Filter),
	}
}

func (c *MockChainClient) SetBlock(hash *chainhash.Hash, block *cashutil.Block) {
...
func TestUtxoScannerScanBasic(t *testing.T) {
	...
	mockChainClient.SetBlock(&block100000Hash, cashutil.NewBlock(&Block100000))
...
func TestUtxoScannerScanAddBlocks(t *testing.T) {
	...
	mockChainClient.SetBlock(&block99999Hash, cashutil.NewBlock(&Block99999))
...
// The following is taken from the bcext/cashutil project.
